        ...
        <div className="mt-5">
          ...
          {!isCollapsed && activeDropdown === "leads" && (
            <div className="pl-9 flex flex-col items-start">
              ...
              <Link
                ...
                to="/agent/leads/all-leads"
              >
                All Leads
              </Link>
              <Link
                className="mb-2 text-sm border-b-2 w-full hover:pl-2 transition-all duration-300 ease-in-out"
                to="/agent/leads/today-leads"
              >
                Today&apos;s Leads
              </Link>
            </div>
          ...
          {!isCollapsed && activeDropdown === "visits" && (
            <div className="pl-9 flex flex-col items-start">
              ...
              <Link
                className="mb-2 text-sm border-b-2 w-full hover:pl-2 transition-all duration-300 ease-in-out"
                to="/agent/visits/all-visits"
              >
                All Visits
              </Link>
              <Link
                className="mb-2 text-sm border-b-2 w-full hover:pl-2 transition-all duration-300 ease-in-out"
                to="/agent/visits/today-planned-visits"
              >
                Today&apos;s Planned Visits
              </Link>
              <Link
                className="mb-2 text-sm border-b-2 w-full hover:pl-2 transition-all duration-300 ease-in-out"
                to="/agent/visits/today-completed-visits"
              >
          ...
          >
            ...
            {!isCollapsed && (
              <span className="text-m font-semibold">Profile</span>
            )}
          </Link>
        </div>
